...
public final class Monster extends Table {
  ...
  public com.zpb.fbs.example.Vec3 pos() { return pos(new com.zpb.fbs.example.Vec3()); }
  public com.zpb.fbs.example.Vec3 pos(com.zpb.fbs.example.Vec3 obj) { int o = __offset(4); return o != 0 ? obj.__assign(o + bb_pos, bb) : null; }
  ...
  public com.zpb.fbs.example.Weapon weapons(int j) { return weapons(new com.zpb.fbs.example.Weapon(), j); }
  public com.zpb.fbs.example.Weapon weapons(com.zpb.fbs.example.Weapon obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int weaponsLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public com.zpb.fbs.example.Weapon.Vector weaponsVector() { return weaponsVector(new com.zpb.fbs.example.Weapon.Vector()); }
  public com.zpb.fbs.example.Weapon.Vector weaponsVector(com.zpb.fbs.example.Weapon.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
